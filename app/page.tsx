    ...
    return (
        <section className="flex flex-col align-middle items-center justify-center gap-4 py-8 md:py-10">
            <div className="inline-block max-w-lg text-center justify-center">
                <h1 className={title()}>Welcome to the {siteConfig.customer.shortname}</h1>
                <br/>
                <h1 className={title({color: "violet"})}>GitHub Handbook</h1>
                <br/>
                <h2 className={subtitle({class: "mt-4"})}>
                    GitHub is the primary source code management platform for the {siteConfig.customer.name}.
                </h2>
            </div>
